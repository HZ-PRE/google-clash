...
echo 正在安装 %APP_NAME% 低版本 Chrome 兼容版...

if not exist "%SRC_ROOT%\manifest.v2.json" (
  echo 未找到 manifest.v2.json
  exit /b 1
)
...
copy /Y "%SRC_ROOT%\manifest.v2.json" "%EXT_DIR%\manifest.json" >nul
